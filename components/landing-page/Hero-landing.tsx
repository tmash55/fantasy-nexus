...
export function HeroSection() {
  return (
    <section
      className="flex flex-col items-center text-center relative mx-auto rounded-2xl overflow-hidden my-6 py-8 px-4
         w-full h-[500px] md:w-[1220px] md:h-[600px] lg:h-[810px] md:px-0 md:py-0"
    >
      {/* SVG Background */}
      ...
      <div className="relative z-10 space-y-6 md:space-y-5 lg:space-y-6 mb-8 md:mb-7 lg:mb-9 max-w-md md:max-w-[500px] lg:max-w-[588px] mt-12 md:mt-[120px] lg:mt-[160px] px-4">
        <h1 className="text-foreground text-3xl md:text-4xl lg:text-6xl font-semibold leading-tight text-balance">
          Vegas‑Powered Fantasy Rankings
        </h1>
        <p className="text-muted-foreground text-base md:text-base lg:text-lg font-medium leading-relaxed max-w-lg mx-auto text-pretty">
          The only fantasy rankings built on sportsbook lines and Vegas totals.
        </p>
      </div>

      <div className="relative z-10 flex flex-col sm:flex-row items-center justify-center gap-4 sm:gap-3 px-4 mb-6">
        <Link href="/nfl/rankings">
          <Button className="bg-gradient-to-r from-primary to-orange-500 text-primary-foreground hover:from-primary/90 hover:to-orange-500/90 px-8 py-3 rounded-full font-medium text-base shadow-lg ring-1 ring-white/10 w-full sm:w-auto">
            See This Week&apos;s Rankings
          </Button>
        </Link>
        <Link href="/nfl/start-sit">
          <Button
            variant="outline"
            className="px-8 py-3 rounded-full font-medium text-base w-full sm:w-auto bg-transparent"
          >
            Try Start/Sit Tool
          </Button>
        </Link>
      ...
      {/* Trust badge */}
      <div className="relative z-10 text-xs sm:text-sm text-muted-foreground">Trusted by 10,000+ fantasy players.</div>
    </section>
  )
}
